      ...
      {showHelp && (
        <Modal title="راهنمای پنل مدیریت" onClose={() => setShowHelp(false)}>
          <div style={{ fontSize: 13.5, color: "#334155", lineHeight: 2.1 }}>
            ...
            <br /><br />
            <b>نتایج و گزارش‌ها:</b> میانگین نمرات و مقایسه‌ی عملکرد به تفکیک معلم و کلاس، و امکان دیدن نتایج ریز هر آزمون. از صفحه‌ی «نتایج» هر معلم می‌توان خروجی Excel هم گرفت: نمره‌ی هر سوال به تفکیک برای یک آزمون خاص، یا خلاصه‌ی نمرات یک کلاس در همه‌ی آزمون‌هایش.
            <br /><br />
